        ...
        <section className="w-full max-w-3xl bg-white dark:bg-neutral-900 rounded-xl shadow-lg p-8 border border-neutral-200 dark:border-neutral-800">
          ...
          <div className="space-y-8 text-base leading-relaxed text-neutral-800 dark:text-neutral-200">
            ...
            <section>
              ...
              <p>Le site Gam&apos;Ex collecte des données personnelles de ses utilisateurs via les formulaires (par exemple : adresse mail, avatar, mot de passe, pseudo).</p>
            ...
            <section>
              ...
              <p>Le site Gam&apos;Ex utilise des cookies d&apos;authentification nécessaires au bon fonctionnement du site et à la gestion des sessions utilisateur. [utilisateur]</p>
            ...
            <section>
              ...
              <p>Kévin Maublanc ne pourra être tenu responsable des dommages directs et indirects causés au matériel de l&apos;utilisateur, lors de l&apos;accès au site Gam&apos;Ex.</p>
              <p>Kévin Maublanc décline toute responsabilité quant à l&apos;utilisation qui pourrait être faite des informations et contenus présents sur Gam&apos;Ex.</p>
              <p>Kévin Maublanc s&apos;engage à sécuriser au mieux le site Gam&apos;Ex, cependant sa responsabilité ne pourra être mise en cause si des données indésirables sont importées et installées sur son site à son insu.</p>
            ...
            <section>
              ...
              <p>Tout litige en relation avec l&apos;utilisation du site Gam&apos;Ex est soumis au droit français. En dehors des cas où la loi ne le permet pas, il est fait attribution exclusive de juridiction aux tribunaux compétents.</p>
            </section>
          </div>
        </section>
      </main>
